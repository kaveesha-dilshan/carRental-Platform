...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title = "What Our Customer Say" subTitle = "Discover why discrening travelers choose StayVenture for their luxury accommodations around the world"/>
